...
- Read `docs/agentic-workflow.md` for initialization, branch handoff, and cross-machine recovery. Existing `docs/ETL_*.md` and review notes are historical inputs, not automatically accepted OpenSpec requirements or active backlogs.
